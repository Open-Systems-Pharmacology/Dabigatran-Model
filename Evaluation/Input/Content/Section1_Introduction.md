...
The presented whole-body PBPK model is based on the model developed by Moj et al. (Moj 2019[https://github.com/Open-Systems-Pharmacology/Dabigatran-Model](https://github.com/Open-Systems-Pharmacology/Dabigatran-Model)) and includes dabigatran, its prodrug dabigatran etexilate and the pharmacologically active metabolite dabigatran acylglucuronide. It was established to be used for DDI predictions as dabigatran etexilate is a widely used Pgp substrate in clinical DDI studies.  
